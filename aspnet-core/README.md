...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p aefbe3fe-111d-4cba-b758-7ee5cd19960c
```

> `aefbe3fe-111d-4cba-b758-7ee5cd19960c` is the password of the certificate, you can change it to any password you want.
